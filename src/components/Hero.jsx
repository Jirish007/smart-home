...
export default function Hero() {
  return (
    <section id="hero" className="text-white text-center py-5" style={{
      ...
      <div className="container py-5">
        ...
        <p className="lead">Reliable automation, enhanced security, and complete control — all in one place.</p>
